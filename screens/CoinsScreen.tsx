...
const CoinsScreen: React.FC = () => {
  ...
  // Reload history every time tab comes into focus
  ...
  // Spin earned = actual wheel values from history (not plays × fixed rate)
...
const LogRow: React.FC<{ log: GameLog }> = ({ log }) => {
  ...
  // For coin: always +5. For spin: show cost paid & coins won separately
...
const styles = StyleSheet.create({
  ...
  outcomePillText: { ...TYPOGRAPHY.small, fontWeight: '600' },
